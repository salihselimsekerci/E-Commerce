...
(function (window, undefined) {
    ...
    jQuery.ajax = function (url, options) {
        ...
        ///     A set of key/value pairs that configure the Ajax request. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings )   a complete list of all settings.
        /// </param>
